          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="bg-[#0BA6DF]/10 p-6 rounded-lg border border-[#0BA6DF]/20">
                <h3 className="font-semibold text-[#0BA6DF] mb-3">Key Benefits:</h3>
                <ul className="space-y-2 text-slate-700">
                  <li className="flex items-center gap-2">
                    <span className="text-[#0BA6DF]">✓</span> Professional Fund Management
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-[#0BA6DF]">✓</span> Instant Diversification
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-[#0BA6DF]">✓</span> Low Minimum Investment
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-[#0BA6DF]">✓</span> Tax Efficiency
                  </li>
                </ul>
              </div>
            </div>
